...
<TypeTable
  type={{
    ...
    scope: {
      description: "OAuth scope for client credentials. For national clouds, use the Graph service origin followed by /.default.",
      type: "string",
      default: '"https://graph.microsoft.com/.default"',
    },
    tokenTimeoutMs: {
      description: "Maximum time to wait for the built-in client-credentials token request, including its response body.",
      type: "number",
      default: "30000",
    },
    saveToSentItems: {
